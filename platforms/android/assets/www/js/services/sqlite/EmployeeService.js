var EmployeeService = function () {
    ...
    this.init = function () {
        if(typeof window.sqlitePlugin === 'undefined') {
            ...
            this.db = sqlitePlugin.openDatabase({name: "empdemo.db", location: 2});
            // this.db = window.sqlitePlugin.openDatabase("EmployeeDemo.db", "1.0", "Employee Demo DB", 0);
        }

        console.log('calling this.db.transaction()');
        this.db.transaction(
            function (tx) {
    ...
    this.initialize = function () {
        ...
        if(typeof window.sqlitePlugin === 'undefined'){
            ...
            this.db = sqlitePlugin.openDatabase("EmployeeDemo.db", "1.0", "Employee Demo DB", 0);
        }
    ...
    this.findByName = function (searchKey) {
        ...
        if(typeof window.sqlitePlugin === 'undefined') {
            alert("sqlitePlugin is undefined");
        }
